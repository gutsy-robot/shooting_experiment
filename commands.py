...
def generate():
	...
	asset_torso_id = rs.addAssetToChannel(chanel_torso_id, [0], (0.2,10))
	...
	asset_speech_id = rs.addAssetToChannel(channel_speech_id, [13], ("Will Kill you,   Soon",))
	asset_head_id = rs.addAssetToChannel(channel_head_id, [10], (2.0,0.5))
	asset_head_id = rs.addAssetToChannel(channel_head_id, [10], (0.0,0.0))
	rs.play()
